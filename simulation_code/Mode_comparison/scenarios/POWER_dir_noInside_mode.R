# Summary level simulations with directional pleiotropy but InSIDE assumption not satisfied (POWER setting)
rm(list = ls())
...
base_name <- paste0(
  "DN_POWER_theta", theta, "_thetaAlt", theta_alt, "_phi1_thetaU", thetaU,
