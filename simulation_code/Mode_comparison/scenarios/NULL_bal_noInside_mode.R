# Summary level simulations with balanced pleiotropy but InSIDE assumption not satisfied (NULL setting)
rm(list = ls())
...
base_name <- paste0(
  "BN_NULL_theta0_thetaAlt", theta_alt, "_phi1_thetaU", thetaU,
