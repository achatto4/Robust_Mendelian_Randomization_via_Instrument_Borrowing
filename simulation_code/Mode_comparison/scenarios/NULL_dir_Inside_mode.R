# Summary level simulations with directional pleiotropy and InSIDE assumption satisfied (NULL setting)
rm(list = ls())
...
base_name <- paste0(
  "DI_NULL_theta0_thetaAlt", theta_alt, "_phi1_thetaU", thetaU,
